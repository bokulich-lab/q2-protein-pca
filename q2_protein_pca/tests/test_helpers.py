...
#
# from q2_protein_pca.archived.alignment import ProtAlign
# from q2_protein_pca.archived.helpers import (
#     split_string,
...
#     locate_positions,
# )
# from q2_protein_pca.archived.ranking import ProtRank
#
#
...
#         cls.test_df = pd.read_csv(os.path.join(cls.cwd, "data/test_data.csv"), index_col=0)
#         cls.expected_ranks = pd.read_csv(
#             os.path.join(cls.cwd, "data/expected_ranks.csv"), index_col=0
#         )
...
#             input_fasta_file=os.path.join(cls.cwd, "data/someseqs.fasta"),
