...
from ProtPCA.helpers import split_string, get_occurrences, rank_alphabet, rank_all_columns, calculate_covariance_matrix, \
    euclidean_distance, make_label, positions_to_color, locate_positions
...
class TestHelpers(TestCase):
    ...
    def setUpClass(cls):
        cls.input_df = pd.DataFrame.from_dict({
            ...
            'seq4': ['A', 'B', 'C', 'D', 'E'],
            'seq5': ['A', 'B', 'C', 'E', '-']
        }, orient='index', columns=['pos1', 'pos2', 'pos3', 'pos4', 'pos5'])
        ...
        cls.test_df = pd.read_csv(os.path.join(cls.cwd, 'test_data.csv'), index_col=0)
        cls.expected_ranks = pd.read_csv(os.path.join(cls.cwd, 'expected_ranks.csv'), index_col=0)
    ...
    def test_get_occurrences(self):
        actual_result = get_occurrences(self.input_df)
    ...
    def test_rank_alphabet(self):
        ...
        actual_result = rank_alphabet(input_series)
    ...
    def test_rank_all_columns(self):
        actual_result = rank_all_columns(self.test_df)
    ...
    def test_variance_covariance(self):
        input_df = pd.DataFrame.from_dict({
            ...
            4: [60, 60, 90],
            5: [30, 30, 30]
        }, orient='index', columns=['Math', 'English', 'Art'])
    ...
    def test_positions_to_color(self):
        ...
        expected_result = pd.DataFrame.from_dict({
            0: [3, 1, 'A', 1.2, 1.2],
            1: [6, 4, 'E', -2.0, 2.0]
        }, orient='index', columns=['PosAln', 'PosRaw', 'AA', "PC score", "Abs PC score"])
    ...
    def test_locate_positions(self):
        ...
        expected_result = [[0, 1, 0.5]], [[3, 4, 0.2], [4, 5, 0.1]], [[1, 2, 0.4], [2, 3, 0.3]]
